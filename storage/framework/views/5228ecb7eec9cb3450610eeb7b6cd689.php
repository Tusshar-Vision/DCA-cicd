<div class="vi-pdf-card">
    <div class="vi-card-header">
        ...
        <a href="#" class="vi-category">Mains 365</a>
    </div>
    <p class="vi-card-body-text">
        <span>[PDF]</span> International Relations Aug22-May23
    </p>
    <div class="vi-card-footer">
        <a href="#" class="vi-downloads-links downloads">Download</a>
        <span class="vi-divider"></span>
        <a href="#" class="vi-downloads-links source-file">View File</a>
    </div>
</div>
<?php /**PATH /home/yash/vision-ca-api/resources/views/components/cards/file-download.blade.php ENDPATH**/ ?>