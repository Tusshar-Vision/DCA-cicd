<?php $__env->startSection('title', 'Monthly Magazine | Current Affairs'); ?>
...
[$__name, $__params] = $__split('widgets.articles-side-bar', ['topics' => $topics,'articles' => $articles]);

$__html = app('livewire')->mount($__name, $__params, 'OyJ0ijg', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'kkpzq8a', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yash/vision-ca-api/resources/views/pages/monthly-magazine.blade.php ENDPATH**/ ?>