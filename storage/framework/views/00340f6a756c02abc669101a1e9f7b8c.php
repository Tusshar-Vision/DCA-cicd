    ...
    <div class="flex items-center justify-between">
        <div class="py-4">
            <a href="/" wire:navigate>
                <img width="200px" src="<?php echo e(asset('images/LightLogo.svg')); ?>" alt="VisionIAS Logo" />
            </a>
        </div>
        ...
        <div class="flex space-x-5 items-center">
            ...
            <?php if(auth()->guard()->check()): ?>
                <div class="flex items-center font-bold cursor-pointer" x-data="{ isUserMenuOpen: false }" @click="isUserMenuOpen = true">
                    ...
                    <?php echo e(Auth::user()->name ?? 'No Name'); ?>


                    <?php if (isset($component)) { $__componentOriginal7b664d123ea47f41a74ba43ef2eee7ae = $component; } ?>
<?php $component = App\View\Components\Auth\UserDropdownMenu::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('auth.user-dropdown-menu'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Auth\UserDropdownMenu::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => 'isUserMenuOpen']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal7b664d123ea47f41a74ba43ef2eee7ae)): ?>
<?php $component = $__componentOriginal7b664d123ea47f41a74ba43ef2eee7ae; ?>
<?php unset($__componentOriginal7b664d123ea47f41a74ba43ef2eee7ae); ?>
<?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
...
<?php /**PATH /home/yash/vision-ca-api/resources/views/components/header/index.blade.php ENDPATH**/ ?>