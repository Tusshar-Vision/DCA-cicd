...
class TableOfContentPolicy
{
    ...
    {
        return $user->can('view-any TableOfContent');
    }
    ...
    {
        return $user->can('view TableOfContent');
    }
    ...
    {
        return $user->can('create TableOfContent');
    }
    ...
    {
        return $user->can('update TableOfContent');
    }
    ...
    {
        return $user->can('delete TableOfContent');
    }
    ...
    {
        return $user->can('restore TableOfContent');
    }
    ...
    {
        return $user->can('force-delete TableOfContent');
    }
}
