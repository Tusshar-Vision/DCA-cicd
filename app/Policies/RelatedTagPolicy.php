...
class RelatedTagPolicy
{
    ...
    {
        return $user->can('view-any RelatedTag');
    }
    ...
    {
        return $user->can('view RelatedTag');
    }
    ...
    {
        return $user->can('create RelatedTag');
    }
    ...
    {
        return $user->can('update RelatedTag');
    }
    ...
    {
        return $user->can('delete RelatedTag');
    }
    ...
    {
        return $user->can('restore RelatedTag');
    }
    ...
    {
        return $user->can('force-delete RelatedTag');
    }
}
