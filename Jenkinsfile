...
"""
                    ...
                    sh "aws ecs update-service --cluster ${ecsCluster} --service ${serviceName} --task-definition ${TaskDefName} --desired-count 1 --force-new-deployment --region ${AWS_DEFAULT_REGION}"
                }
            }
        }
    }
