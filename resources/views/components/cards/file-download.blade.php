...
<div class="vi-pdf-card">
    <div class="vi-card-header">
        ...
        @if(
            ...
            <a href="{{ route($pdf->collection_name . '.archive') }}" class="vi-category" wire:navigate>{{ ucfirst($pdf->collection_name) }}</a>
        @else
    ...
    <div class="vi-card-footer">
        ...
        @if(
            ...
            @else
                <a wire:navigate href="{{ route($pdf->collection_name) . '/archive/' . $pdf->id }}" class="flex items-center vi-downloads-links source-file">
                    <span>Read</span>
                </a>
            @endif
        @else
