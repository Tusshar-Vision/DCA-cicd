            ...
            <li class="text-center mb-4 md:mb-0">
                <a href="https://twitter.com/share?url={{ url()->full() }}" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none" class="m-auto">
                        ...
                        <path d="M14.2045 34.5879H18.1818V24.9289L15.5774 20.3811L12.5 20.6675V32.8834C12.5 33.8251 13.2628 34.5879 14.2045 34.5879Z" fill="#0085F7"/>
                        <path d="M31.8184 34.5877H35.7957C36.7374 34.5877 37.5002 33.8249 37.5002 32.8832V20.6672L34.4272 20.3809L31.8184 24.9286V34.5877H31.8184Z" fill="#00A94B"/>
                        <path d="M31.8187 17.5424L29.4824 22.0005L31.8187 24.9288L37.5005 20.6674V18.3947C37.5005 16.2881 35.0957 15.085 33.4096 16.3492L31.8187 17.5424Z" fill="#FFBC00"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M18.1813 24.9289L15.9551 20.2262L18.1813 17.5425L24.9995 22.6561L31.8176 17.5425V24.9289L24.9995 30.0425L18.1813 24.9289Z" fill="#FF4131"/>
                        <path d="M12.5 18.3947V20.6674L18.1818 24.9288V17.5424L16.5909 16.3492C14.9048 15.085 12.5 16.2881 12.5 18.3947V18.3947Z" fill="#E51C19"/>
                      </svg>
