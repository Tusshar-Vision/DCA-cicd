<div class="flex flex-col rounded border-top mt-4 {{ $video === null ? 'opacity-50 pointer-events-none' : 'cursor-pointer' }} dark:bg-dark373839 dark:text-white" @click="isVideoOpen = true">
    <div class="my-8 mx-6">
