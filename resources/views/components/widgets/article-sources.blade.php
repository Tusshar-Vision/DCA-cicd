<div x-data="{ expanded: false }" :class="{ 'items-center': !expanded }" class="border-2 border-visionSelectedGray rounded mt-[20px] px-4 py-2">
    <div @click="expanded = ! expanded" class="cursor-pointer text-[#3D3D3D] hover:text-[#3362CC] dark:text-white flex justify-between border-b-[1px] hover:border-b-[#3362CC] w-full pb-2 svgHover">
    ...
    <div x-show="expanded" class="text-[#3D3D3D] dark:text-white text-sm font-light flex flex-col mt-4 pb-2" x-collapse>
