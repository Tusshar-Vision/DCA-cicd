...
<div class="flex flex-col rounded bg-visionGray mb-4">
    <div class="my-8 mx-6">
        <div class="flex items-center justify-between cursor-pointer" @click="{{$videoUrl ? 'isVideoOpen=true' : ''}}">
                ...
                <span>
                    {{
                        ...
                        (
                            ...
                            "Watch Today's News" : 'Download Magazine'
                        )
                    }}
                </span>
            </div>
...
<div class="flex flex-col rounded bg-visionGray lg:mt-0 mt-8">
    <div class="my-8 mx-6 {{ $mediaFile === null ? 'opacity-50' : '' }}">
            <a href="{{ $mediaFile ? route('download', ['media' => $mediaFile]): "#"}}" class="{{ $mediaFile === null ? 'pointer-events-none' : '' }}" target="_blank">
