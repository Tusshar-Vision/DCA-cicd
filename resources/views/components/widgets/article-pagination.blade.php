    ...
    @if($previousArticleIndex !== null)
        <div class="flex flex-col items-center cursor-pointer">
            ...
            >
                ...
                <span class="block text-wrap">{{ $currentInitiative->articles[$previousArticleIndex]->title }}</span>
            </a>
        </div>
    @endif
    ...
    @if($nextArticleIndex !== null)
        <div class="flex flex-col items-center cursor-pointer">
            <a wire:navigate id="nxt-article-btn" href="{{ ArticleService::getArticleUrlFromSlug($currentInitiative->articles[$nextArticleIndex]->slug) }}">
                ...
                <span class="block text-wrap">{{ $currentInitiative->articles[$nextArticleIndex]->title }}</span>
            </a>
        </div>
    @endif
</div>
