<div class="flex justify-between mt-2 md:mt-0 space-x-2">
    ...
    <div class="flex items-center space-x-2">
        <button @click="document.querySelector('.printable-area').style.fontSize = `${(isNaN(parseFloat(document.querySelector('.printable-area').style.fontSize)) ? 1.1 : parseFloat(document.querySelector('.printable-area').style.fontSize) + 0.1)}rem`">
        ...
        <button @click="document.querySelector('.printable-area').style.fontSize = `${(isNaN(parseFloat(document.querySelector('.printable-area').style.fontSize)) ? 0.9 : parseFloat(document.querySelector('.printable-area').style.fontSize) - 0.1)}rem`">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="1" y="1" width="22" height="22" stroke="#8F93A3" stroke-width="2"/>
