    ...
    <x-containers.grid-wide class="mt-6">
        <div class="flex flex-col md:flex-row">
            <ul class="flex space-x-2 overflow-x-auto p-2 mb-4 md:justify-center flex-grow">
                <li>
                    <a href="{{ route('videos') }}" wire:navigate class="text-[14px] text-nowrap rounded-md px-3 py-2 text-[#040404] bg-[#F4F4F6] hover:text-[#3362CC] {{ request()->is('videos*') ? 'text-white !bg-[#3362CC] hover:text-white' : '' }}">
                        Latest Videos
                    </a>
                </li>
                <li>
