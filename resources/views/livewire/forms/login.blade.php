<div class="flex flex-col min-h-[680px] justify-center text-center items-stretch bg-white py-[50px]">
    <div class="w-full xl:w-6/12 flex items-center bg-white xl:bg-[#F5F7F8] mb-[40px] xl:mb-0">
    ...
    <div class="w-full xl:w-6/12 flex flex-col justify-center px-[56px] loginwrap">
        ...
        <form wire:submit="login">
            ...
            <button type="button" class="sign-up" @click="isLoginFormOpen = false;isRegisterFormOpen = true;">New User?
                Sign up</button>
        </form>
    </div>
</div>
