     ...
     <div class="my-content-tab-wrapper rounded">
         ...
         <div class="breadcrumb-wrapper">
             <ul>
                 ...
                 @endif
                 @if ($topic)
                     <li><a href="javascript:void(0)" class="active">{{ $topic }}</a></li>
                 @endif
                 @if ($section)
                     <li><a href="javascript:void(0)" class="active">{{ $section }}</a></li>
                 @endif
             </ul>
         </div>
                 ...
                 <div class="ci-tab-acc-content">
                     <div class="vi-note-and-high-list">
                         ...
                         <div class="vi-note">
                             ...
                             <div class="note-content">
                                 <p class="vi-text-light">A scelerisque purus semper eget duis. Dignissim cras tincidunt
                                     lobortis feugiat vivamus at augue eget arcu.</p>
                         ...
                         <div class="vi-note">
                             ...
                             <div class="note-content">
                                 <p class="vi-text-dark vi-yellow-text">Dignissim enim sit amet venenatis urna cursus
                                     eget nunc. Dignissim enim sit amet venenatis urna cursus eget nunc. Dignissim enim
                                     sit amet venenatis urna cursus eget nunc.</p>
                             </div>
                             <div class="vi-note-action">
                                 <a href="#" class="vi-icons note-delete"></a>
                             </div>
                         ...
                         <div class="vi-note">
                             ...
                             <div class="note-content">
                                 <p class="vi-text-dark vi-yellow-text">Dignissim enim sit amet venenatis urna cursus
                                     eget nunc. Dignissim enim
                                     sit amet venenatis urna cursus eget nunc. Dignissim enim sit amet venenatis urna
                                     cursus eget nunc.</p>
                             </div>
                             <div class="vi-note-action">
                                 <a href="#" class="vi-icons note-delete"></a>
