<div>
    ...
    <div class="relative w-[100%]">
        <input type="search" class="w-[100%] rounded-md border-[#C3CAD9]" onfocus="onSearchfocus('paper')"
            onblur="onSearchblur('paper')">
        <div id="paper"
            class="absolute z-10 left-0 top-[42px] w-[100%] max-h-[150px] hidden overflow-auto rounded-md bg-[#FCFCFC]">
    ...
    <div class="relative w-[100%]">
        <input type="search" class="w-[100%] rounded-md border-[#C3CAD9]" onfocus="onSearchfocus('subject')"
            onblur="onSearchblur('subject')">
        <div id="subject"
            class="absolute z-10 left-0 top-[42px] w-[100%] max-h-[150px] hidden overflow-auto rounded-md bg-[#FCFCFC]">
    ...
    <div class="relative w-[100%]">
        <input type="search" class="w-[100%] rounded-md border-[#C3CAD9]" onfocus="onSearchfocus('section')"
            onblur="onSearchblur('section')">
        <div id="section"
            class="absolute z-10 left-0 top-[42px] w-[100%] max-h-[150px] hidden overflow-auto rounded-md bg-[#FCFCFC]">
