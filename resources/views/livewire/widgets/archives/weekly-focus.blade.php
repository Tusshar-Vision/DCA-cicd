...
<div class="w-full">
    <div class="pt-[25px] border-t-2">
        <div class="flex w-full items-center justify-between xl:justify-end space-x-4 mb-[25px]">
            <div class="block xl:hidden flex items-center cursor-pointer" onclick="myFunction()">
                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="16" viewBox="0 0 8 16" fill="none">
                    <path d="M6.86719 15.0156L0.99998 8.49977" stroke="#242424" class="dark:stroke-white" stroke-linecap="round"/>
                    <line x1="0.5" y1="-0.5" x2="9.61301" y2="-0.5"
                          transform="matrix(-0.654931 0.755689 0.654931 0.755689 7.65625 1.30469)" stroke="#242424" class="dark:stroke-white" stroke-linecap="round"/>
                </svg>
    ...
    @foreach ($data as $year => $yearData)
        <div x-data="{ expanded: {{$i==0 ? 'true': 'false'}} }"  class="archiveWrapper mb-[15px] border-b-2">
            <div class="flex justify-between items-center archiveHeader cursor-pointer" @click="expanded = ! expanded">
                <h4 class="text-[#040404] dark:text-white text-[32px] font-normal mb-[15px]">{{ $year }}</h4>
                <div>
...
{{--                                        </div>--}}
    ...
    @endforeach
@else
    <livewire:widgets.pdf-viewer :pdf="$pdfUrl" initiative="weekly-focus.archive" />
@endif
</div>
