<div class="w-full">
    <div class="pt-[25px] border-t-2">
        <div class="flex w-full items-center justify-between xl:justify-end space-x-4 mb-[25px]">
            <div class="block xl:hidden flex items-center">
                ...
                <h4 class="text-sm md:text-lg font-normal text-[#242424] dark:text-white ml-2 md:ml-4">Previous Year Questions</h4>
            </div>
            @if(!$pdfUrl)
    ...
    @else
        <livewire:widgets.pdf-viewer :pdf="$pdfUrl" initiative="previous-year-question" />
    @endif
</div>
