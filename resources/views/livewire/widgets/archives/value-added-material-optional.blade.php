        ...
        <div class="flex w-full items-center justify-between xl:justify-end space-x-4 mb-[25px]">
            <div class="block xl:hidden flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="16" viewBox="0 0 8 16" fill="none" onclick="myFunction()" class="cursor-pointer">
                    <path d="M6.86719 15.0156L0.99998 8.49977" stroke="#242424" class="dark:stroke-whitew" stroke-linecap="round"/>
                    <line x1="0.5" y1="-0.5" x2="9.61301" y2="-0.5" transform="matrix(-0.654931 0.755689 0.654931 0.755689 7.65625 1.30469)" stroke="#242424" class="dark:stroke-whitew" stroke-linecap="round"/>
                </svg>
                <h4 class="text-sm md:text-lg font-normal font-[#242424] dark:text-white ml-2 md:ml-4">Value Added Material (Optional)</h4>
            </div>
                 ...
                 <div>
                    <div x-show="expanded === true">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5 11V13H19V11H5Z" fill="#8F93A3" class="dark:fill-whitew"/>
                        </svg>
                    </div>
                    <div x-show="expanded === false">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z" fill="#8F93A3" class="dark:fill-whitew"/>
                        </svg>
                    </div>
                </div>
            </div>
